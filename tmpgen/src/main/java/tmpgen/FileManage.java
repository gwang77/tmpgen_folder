...
public final class FileManage {
    ...
    public static String readTextFile(String filepath, String encode) {
        if (filepath == null || filepath.trim().length() == 0) {
            return null;
        }
        try {
            ...
            contents = new String(contents.getBytes(StandardCharsets.ISO_8859_1), encode);
            return contents;
        } catch (Exception e) {
